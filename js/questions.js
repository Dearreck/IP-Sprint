...
import {
    ...
    generateSpecialAddressExplanationHTML // Para explicaciones de IPs especiales
} from './utils.js';
...
function generateTypeQuestion() {
    try {
        ...
        info = getIpInfo(ip);
        // Reintenta si la IP generada es de tipo inválido (N/A) o Loopback
        // También evita preguntar por APIPA o Broadcast Limitado aquí (se ven en Associate)
...
function generateRfc1918Question() {
    try {
        ...
        if (questionType === 0) {
            ...
            // Preguntar por Clase
            const blockIdentifier = chosenBlock.blockId; // Usar '10.0.0.0/8', etc.
...
const associateQuestionGenerators = [
    ...
    generateRfc1918Question,           // Preguntas sobre bloques privados (CIDR, Rango, Clase)
    generateSpecialAddressQuestion,    // Preguntas sobre Loopback, APIPA, Broadcast Limitado
    // TODO: Añadir generador para:
    // generateNetworkBroadcastAddressQuestion (Cálculo de Dir Red/Broadcast con máscara default)
];
